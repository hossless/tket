...
export default function TicketCard({ ticket }) {
  ...
  return (
    <Link 
      to={`/ticket/${ticket_id}`} 
      className={`group bg-[#FFFFFF] dark:bg-[#232130] rounded-2xl overflow-hidden border border-[#E5E7EB] dark:border-[#2D2B3D] shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full ${overlayMode ? 'opacity-80 grayscale-[0.6] hover:border-[#E5E7EB] dark:hover:border-[#2D2B3D]' : 'hover:border-[#8B5CF6] dark:hover:border-[#B794F4]'}`}
    >
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="text-sm text-[#6B7280] dark:text-[#A2A2CC] mb-6 space-y-2 font-medium">
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="shrink-0 w-4 h-4">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
            </svg>
            <span className="truncate">{venue_city || 'Location TBA'}</span>
          </div>
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="shrink-0 w-4 h-4">
