...
export default function AdminPanel() {
  ...
  const [isShellMounted, setIsShellMounted] = useState(false);
  ...
  useEffect(() => {
    setTimeout(() => setIsShellMounted(true), 50);
  }, []);
  ...
  return (
    <>
      ...
      <div className={`max-w-7xl mx-auto px-4 py-12 min-h-[101vh] transition-all duration-700 transform ${isShellMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="mb-10">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          <div className={`w-full md:w-64 shrink-0 flex flex-col gap-2 transition-all duration-700 delay-100 transform ${isShellMounted ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
            <button 
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                <path fillRule="evenodd" d="M1.5 6.375c0-1.036.84-1.875 1.875-1.875h17.25c1.035 0 1.875.84 1.875 1.875v3.026a2.999 2.999 0 0 1 0 5.198v3.026c0 1.036-.84 1.875-1.875 1.875H3.375A1.875 1.875 0 0 1 1.5 17.625v-3.026a2.999 2.999 0 0 1 0-5.198V6.375Zm15-1.125a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-1.5 0V6a.75.75 0 0 1 .75-.75Zm.75 4.5a.75.75 0 0 0-1.5 0v.75a.75.75 0 0 0 1.5 0v-.75Zm-.75 3a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-1.5 0v-.75a.75.75 0 0 1 .75-.75Zm.75 4.5a.75.75 0 0 0-1.5 0V18a.75.75 0 0 0 1.5 0v-.75ZM6 12a.75.75 0 0 1 .75-.75H12a.75.75 0 0 1 0 1.5H6.75A.75.75 0 0 1 6 12Zm.75 2.25a.75.75 0 0 0 0 1.5h3a.75.75 0 0 0 0-1.5h-3Z" clipRule="evenodd" />
              </svg>
              Reservations
            </button>
          ...
          <div className="flex-1 w-full min-h-[600px]">
            ...
            {activeTab === 'Reservations' && (
              <AnimatedWrapper key="reservations-tab" className="bg-[#FFFFFF] dark:bg-[#232130] rounded-3xl border border-[#E5E7EB] dark:border-[#2D2B3D] shadow-sm overflow-hidden">
            ...
            {activeTab === 'Reports' && (
              <AnimatedWrapper key="reports-tab" className="bg-[#FFFFFF] dark:bg-[#232130] rounded-3xl border border-[#E5E7EB] dark:border-[#2D2B3D] shadow-sm p-8">
                        ...
                        <div className="shrink-0 flex flex-col items-end gap-2">
                          ...
                          {report.report_status === 'Waiting' && (
                            <button 
                              ...
                              className="mt-1 px-4 py-1.5 bg-[#8B5CF6]/10 text-[#8B5CF6] hover:bg-[#8B5CF6]/20 rounded-lg text-xs font-bold transition-colors active:scale-95"
                            >
                              Reply & Resolve
                            </button>
                          )}
            ...
            {activeTab === 'CreateEvent' && (
              <AnimatedWrapper key="create-event-tab" className="bg-[#FFFFFF] dark:bg-[#232130] rounded-3xl border border-[#E5E7EB] dark:border-[#2D2B3D] shadow-sm p-8 sm:p-12">
                <div className="mb-8">
                  <h2 className="text-2xl font-extrabold text-[#111827] dark:text-[#FFFFFF]">Create New Event</h2>
                  <p className="text-sm text-[#6B7280] dark:text-[#A2A2CC] mt-1">Publish a new ticket.</p>
                </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <input type="text" name="tournament_name" value={ticketForm.tournament_name} onChange={handleTicketChange} placeholder="e.g. Premier League" className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:ring-2 focus:ring-[#8B5CF6] outline-none transition-shadow" />
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-[#6B7280] dark:text-[#A2A2CC] uppercase tracking-wider mb-2">Home Team</label>
                        <input type="text" name="home_team" value={ticketForm.home_team} onChange={handleTicketChange} required placeholder="e.g. Man City" className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:ring-2 focus:ring-[#8B5CF6] outline-none transition-shadow" />
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-[#6B7280] dark:text-[#A2A2CC] uppercase tracking-wider mb-2">Away Team</label>
                        <input type="text" name="away_team" value={ticketForm.away_team} onChange={handleTicketChange} required placeholder="e.g. Man United" className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:ring-2 focus:ring-[#8B5CF6] outline-none transition-shadow" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input type="text" name="venue_name" value={ticketForm.venue_name} onChange={handleTicketChange} placeholder="e.g. Ettihad Stadium" className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:ring-2 focus:ring-[#8B5CF6] outline-none transition-shadow" />
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-[#6B7280] dark:text-[#A2A2CC] uppercase tracking-wider mb-2">City</label>
                        <input type="text" name="venue_city" value={ticketForm.venue_city} onChange={handleTicketChange} required placeholder="e.g. Madrid" className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:ring-2 focus:ring-[#8B5CF6] outline-none transition-shadow" />
                      </div>
                      <div>
                        ...
                        <DatePicker
                          ...
                          className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:outline-none focus:ring-2 focus:ring-[#8B5CF6] text-sm shadow-sm placeholder-[#9CA3AF] dark:placeholder-[#6B7280] transition-shadow"
                          required
                        />
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-[#6B7280] dark:text-[#A2A2CC] uppercase tracking-wider mb-2">Facilities</label>
                        <input type="text" name="facilities" value={ticketForm.facilities} onChange={handleTicketChange} placeholder="e.g. VIP Lounge, Free Wifi" className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:ring-2 focus:ring-[#8B5CF6] outline-none transition-shadow" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                      <div>
                        ...
                        <select name="category" value={ticketForm.category} onChange={handleTicketChange} required className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:ring-2 focus:ring-[#8B5CF6] outline-none transition-shadow">
                      ...
                      <div>
                        ...
                        <input type="number" min="1" name="total_capacity" value={ticketForm.total_capacity} onChange={handleTicketChange} required placeholder="e.g. 5000" className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:ring-2 focus:ring-[#8B5CF6] outline-none font-mono transition-shadow" />
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-[#6B7280] dark:text-[#A2A2CC] uppercase tracking-wider mb-2">Price ($)</label>
                        <input type="number" step="0.01" min="0" name="price" value={ticketForm.price} onChange={handleTicketChange} required placeholder="e.g. 150.00" className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:ring-2 focus:ring-[#8B5CF6] outline-none font-mono text-[#8B5CF6] dark:text-[#B794F4] transition-shadow" />
                      </div>
                    </div>
                  </div>

                  <div className="pt-6 flex justify-end">
                    <button disabled={isCreatingTicket} type="submit" className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-[#7C3AED] to-[#8B5CF6] text-white rounded-xl font-bold hover:scale-[1.02] active:scale-95 transition-transform shadow-[0_0_15px_rgba(139,92,246,0.3)] disabled:opacity-70 flex justify-center items-center gap-2">
                      {isCreatingTicket ? (
        ...
        <form onSubmit={handleReplySubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full p-3.5 rounded-xl bg-[#F9FAFB] dark:bg-[#1A1924] border border-[#E5E7EB] dark:border-[#2D2B3D] text-[#111827] dark:text-[#FFFFFF] focus:ring-2 focus:ring-[#8B5CF6] outline-none resize-none transition-shadow"
            ></textarea>
          </div>

          <div className="pt-2 flex justify-end">
            <button disabled={isSubmitting} type="submit" className="w-full sm:w-auto px-6 py-3 bg-[#111827] dark:bg-[#FFFFFF] text-white dark:text-[#1A1924] rounded-xl font-bold hover:bg-[#374151] dark:hover:bg-[#E5E7EB] active:scale-95 transition-all disabled:opacity-70 flex justify-center items-center gap-2">
